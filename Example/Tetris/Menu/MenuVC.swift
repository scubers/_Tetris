...
class MenuVC: BaseVC, Routable {
    ...
    var intents: [[String: Intent]] = [
        ...
        ["10. Invalid url: /a/b/c?abc={xx}" : Intent.pushPop(byUrl: "/a/b/c?abc={xx}")],
    ]
    ...
    @objc func change() {
        TSTetris.shared().router.postDriven(byUrl: "/changeDemo".to_tsUrl(), params: nil)
    }
